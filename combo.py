...
print()
print(
    f"Percentage of games with disposals greater than {input_disposals} and goals greater than {input_goals}: {percentage_disposals_greater_goals_greater *100:.2f}%"
)
print()
print(
    f"Percentage of games with disposals greater than {input_disposals} and goals less than {input_goals}: {percentage_disposals_greater_goals_less *100:.2f}%"
)
print()
print(
    f"Percentage of games with disposals less than {input_disposals} and goals greater than {input_goals}: {percentage_disposals_less_goals_greater *100:.2f}%"
)
print()
print(
    f"Percentage of games with disposals less than {input_disposals} and goals less than {input_goals}: {percentage_disposals_less_goals_less *100:.2f}%"
)
print()
print(
    f"True odds for games with disposals greater than {input_disposals} and goals greater than {input_goals} based on past performance: ${1/percentage_disposals_greater_goals_greater:.2f}"
)
print()
print(
    f"True odds for games with disposals greater than {input_disposals} and goals less than {input_goals} based on past performance: ${1/percentage_disposals_greater_goals_less:.2f}"
)
print()
print(
    f"True odds for games with disposals less than {input_disposals} and goals greater than {input_goals} based on past performance: ${1/percentage_disposals_less_goals_greater.2f}"
)
print()
print(
    f"True odds for games with disposals less than {input_disposals} and goals less than {input_goals} based on past performance: ${1/percentage_disposals_less_goals_less:.2f}"
)
print()
print()
...
print()
print(
    f"Percentage of games with disposals greater than {input_disposals} and goals greater than {input_goals}: {percentage_disposals_greater_goals_greater_location *100:.2f}%"
)
print()
print(
    f"Percentage of games with disposals greater than {input_disposals} and goals less than {input_goals}: {percentage_disposals_greater_goals_less_location *100:.2f}%"
)
print()
print(
    f"Percentage of games with disposals less than {input_disposals} and goals greater than {input_goals}: {percentage_disposals_less_goals_greater_location *100:.2f}%"
)
print()
print(
    f"Percentage of games with disposals less than {input_disposals} and goals less than {input_goals}: {percentage_disposals_less_goals_less_location *100:.2f}%"
)
print()
print(
    f"True odds for games with disposals greater than {input_disposals} and goals greater than {input_goals} based on past performance: ${1/percentage_disposals_greater_goals_greater_location:.2f}"
)
print()
print(
    f"True odds for games with disposals greater than {input_disposals} and goals less than {input_goals} based on past performance: ${1/percentage_disposals_greater_goals_less_location:.2f}"
)
print()
print(
    f"True odds for games with disposals less than {input_disposals} and goals greater than {input_goals} based on past performance: ${1/percentage_disposals_less_goals_greater_location:.2f}"
)
print()
print(
    f"True odds for games with disposals less than {input_disposals} and goals less than {input_goals} based on past performance: ${1/percentage_disposals_less_goals_less_location:.2f}"
)
print()
print()
...
print()
print(
    f"Percentage of games with disposals greater than {input_disposals} and goals greater than {input_goals}: {percentage_disposals_greater_goals_greater_opposition *100:.2f}%"
)
print()
print(
    f"Percentage of games with disposals greater than {input_disposals} and goals less than {input_goals}: {percentage_disposals_greater_goals_less_opposition *100:.2f}%"
)
print()
print(
    f"Percentage of games with disposals less than {input_disposals} and goals greater than {input_goals}: {percentage_disposals_less_goals_greater_opposition *100:.2f}%"
)
print()
print(
    f"Percentage of games with disposals less than {input_disposals} and goals less than {input_goals}: {percentage_disposals_less_goals_less_opposition *100:.2f}%"
)
print()
print(
    f"True odds for games with disposals greater than {input_disposals} and goals greater than {input_goals} based on past performance: ${1/percentage_disposals_greater_goals_greater_opposition:.2f}"
)
print()
print(
    f"True odds for games with disposals greater than {input_disposals} and goals less than {input_goals} based on past performance: ${1/percentage_disposals_greater_goals_less_opposition:.2f}"
)
print()
print(
    f"True odds for games with disposals less than {input_disposals} and goals greater than {input_goals} based on past performance: ${1/percentage_disposals_less_goals_greater_opposition:.2f}"
)
print()
print(
    f"True odds for games with disposals less than {input_disposals} and goals less than {input_goals} based on past performance: ${1/percentage_disposals_less_goals_less_opposition:.2f}"
)
print()
print()
...
print()
print(
    f"Percentage of games with disposals greater than {input_disposals} and goals greater than {input_goals}: {percentage_disposals_greater_goals_greater_venue *100:.2f}%"
)
print()
print(
    f"Percentage of games with disposals greater than {input_disposals} and goals less than {input_goals}: {percentage_disposals_greater_goals_less_venue *100:.2f}%"
)
print()
print(
    f"Percentage of games with disposals less than {input_disposals} and goals greater than {input_goals}: {percentage_disposals_less_goals_greater_venue *100:.2f}%"
)
print()
print(
    f"Percentage of games with disposals less than {input_disposals} and goals less than {input_goals}: {percentage_disposals_less_goals_less_venue *100:.2f}%"
)
print()
print(
    f"True odds for games with disposals greater than {input_disposals} and goals greater than {input_goals} based on past performance: ${1/percentage_disposals_greater_goals_greater_venue:.2f}"
)
print()
print(
    f"True odds for games with disposals greater than {input_disposals} and goals less than {input_goals} based on past performance: ${1/percentage_disposals_greater_goals_less_venue:.2f}"
)
print()
print(
    f"True odds for games with disposals less than {input_disposals} and goals greater than {input_goals} based on past performance: ${1/percentage_disposals_less_goals_greater_venue:.2f}"
)
print()
print(
    f"True odds for games with disposals less than {input_disposals} and goals less than {input_goals} based on past performance: ${1/percentage_disposals_less_goals_less_venue:.2f}"
)
print()
print()
...
print()
print(
    f"Percentage of games with disposals greater than {input_disposals} and goals greater than {input_goals}: {percentage_disposals_greater_goals_greater_2023 *100:.2f}%"
)
print()
print(
    f"Percentage of games with disposals greater than {input_disposals} and goals less than {input_goals}: {percentage_disposals_greater_goals_less_2023 *100:.2f}%"
)
print()
print(
    f"Percentage of games with disposals less than {input_disposals} and goals greater than {input_goals}: {percentage_disposals_less_goals_greater_2023 *100:.2f}%"
)
print()
print(
    f"Percentage of games with disposals less than {input_disposals} and goals less than {input_goals}: {percentage_disposals_less_goals_less_2023 *100:.2f}%"
)
print()
print(
    f"True odds for games with disposals greater than {input_disposals} and goals greater than {input_goals} based on past performance: ${1/percentage_disposals_greater_goals_greater_2023:.2f}"
)
print()
print(
    f"True odds for games with disposals greater than {input_disposals} and goals less than {input_goals} based on past performance: ${1/percentage_disposals_greater_goals_less_2023:.2f}"
)
print()
print(
    f"True odds for games with disposals less than {input_disposals} and goals greater than {input_goals} based on past performance: ${1/percentage_disposals_less_goals_greater_2023:.2f}"
)
print()
print(
    f"True odds for games with disposals less than {input_disposals} and goals less than {input_goals} based on past performance: ${1/percentage_disposals_less_goals_less_2023:.2f}"
)
print()
print()
...
print()
print(
    f"Percentage of games with disposals greater than {input_disposals} and goals greater than {input_goals}: {percentage_disposals_greater_goals_greater_time *100:.2f}%"
)
print()
print(
    f"Percentage of games with disposals greater than {input_disposals} and goals less than {input_goals}: {percentage_disposals_greater_goals_less_time *100:.2f}%"
)
print()
print(
    f"Percentage of games with disposals less than {input_disposals} and goals greater than {input_goals}: {percentage_disposals_less_goals_greater_time *100:.2f}%"
)
print()
print(
    f"Percentage of games with disposals less than {input_disposals} and goals less than {input_goals}: {percentage_disposals_less_goals_less_time *100:.2f}%"
)
print()
print(
    f"True odds for games with disposals greater than {input_disposals} and goals greater than {input_goals} based on past performance: ${1/percentage_disposals_greater_goals_greater_time:.2f}"
)
print()
print(
    f"True odds for games with disposals greater than {input_disposals} and goals less than {input_goals} based on past performance: ${1/percentage_disposals_greater_goals_less_time:.2f}"
)
print()
print(
    f"True odds for games with disposals less than {input_disposals} and goals greater than {input_goals} based on past performance: ${1/percentage_disposals_less_goals_greater_time:.2f}"
)
print()
print(
    f"True odds for games with disposals less than {input_disposals} and goals less than {input_goals} based on past performance: ${1/percentage_disposals_less_goals_less_time:.2f}"
)
print()
print()
...
print()
print(
    f"Percentage of games with disposals greater than {input_disposals} and goals greater than {input_goals}: {percentage_disposals_greater_goals_greater_dayofweek *100:.2f}%"
)
print()
print(
    f"Percentage of games with disposals greater than {input_disposals} and goals less than {input_goals}: {percentage_disposals_greater_goals_less_dayofweek *100:.2f}%"
)
print()
print(
    f"Percentage of games with disposals less than {input_disposals} and goals greater than {input_goals}: {percentage_disposals_less_goals_greater_dayofweek *100:.2f}%"
)
print()
print(
    f"Percentage of games with disposals less than {input_disposals} and goals less than {input_goals}: {percentage_disposals_less_goals_less_dayofweek *100:.2f}%"
)
print()
print(
    f"True odds for games with disposals greater than {input_disposals} and goals greater than {input_goals} based on past performance: ${1/percentage_disposals_greater_goals_greater_dayofweek:.2f}"
)
print()
print(
    f"True odds for games with disposals greater than {input_disposals} and goals less than {input_goals} based on past performance: ${1/percentage_disposals_greater_goals_less_dayofweek:.2f}"
)
print()
print(
    f"True odds for games with disposals less than {input_disposals} and goals greater than {input_goals} based on past performance: ${1/percentage_disposals_less_goals_greater_dayofweek:.2f}"
)
print()
print(
    f"True odds for games with disposals less than {input_disposals} and goals less than {input_goals} based on past performance: ${1/percentage_disposals_less_goals_less_dayofweek:.2f}"
)
print()
print()
